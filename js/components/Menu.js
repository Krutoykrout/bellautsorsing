class Menu {
    ...
    _handleActiveLink() {
        ...
        this.sections.forEach(section => {
            const sectionTop = section.offsetTop - this.header.offsetHeight - this.SCROLL_OFFSET;
    ...
    _handleLinkClick(event) {
        ...
        window.mobileMenuObject.remove();
        ...
        if (targetSection) {
            ...
            const targetPosition = targetSection.offsetTop - headerHeight - this.SCROLL_OFFSET;
